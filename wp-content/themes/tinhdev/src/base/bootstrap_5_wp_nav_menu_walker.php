...
class bootstrap_5_wp_nav_menu_walker extends Walker_Nav_menu{
    ...
    function start_lvl(&$output, $depth = 0, $args = NULL){
        ...
        $output  .= "\n$indent<ul class=\"dropdown-menu$submenu " . esc_attr(implode(" ",
                $dropdown_menu_class)) . " depth_$depth\">\n";
    }
    ...
    function start_el(&$output, $item, $depth = 0, $args = NULL, $id = 0){
        ...
        $active_class   = ($item->current || $item->current_item_ancestor || in_array("current_page_parent",
                $item->classes, TRUE) || in_array("current-post-ancestor", $item->classes,
                TRUE)) ? 'active' : '';
